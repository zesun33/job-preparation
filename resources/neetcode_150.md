# NeetCode 150 Problem List (Draft)
...
| 11 | Number of Connected Components in Undirected Graph | 🟡 | |
| 12 | Graph Valid Tree | 🟡 | |
| 13 | Word Ladder | 🔴 | |
...
**Next steps**  
1. Add links to the official LeetCode problem page.  
2. Export to CSV for spreadsheet tracking (optional).
